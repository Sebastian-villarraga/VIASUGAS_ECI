...
-- =====================================================
-- TIPO TRANSACCION (CORREGIDO)
-- =====================================================

INSERT INTO tipo_transaccion VALUES
('TT1','FLETE','Ingreso viaje','INGRESO MANIFIESTO','activo',NOW()),
('TT2','PEAJE','Peajes','EGRESO MANIFIESTO','activo',NOW()),
('TT3','COMBUSTIBLE','Gasolina','EGRESO MANIFIESTO','activo',NOW()),
('TT4','NOMINA','Pago empleados','EGRESO OPERACIONAL','activo',NOW()),
('TT5','MANTENIMIENTO','Taller','EGRESO OPERACIONAL','activo',NOW());
